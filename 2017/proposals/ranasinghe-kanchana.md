...
Given this functionality, the final task is entwining all this functionality to imshow to allow the plotting of heat-maps. Also integration with other scalarMappables will be carried out. This will focus on providing units support for the existing functions with regards to categorical data, followed by integration of the existing frameworks (including those built previously in this project) to better support categorical data visualization. 
...
### July 3rd - July 7th
* norm and cmap basic functionality including tests and documentation
