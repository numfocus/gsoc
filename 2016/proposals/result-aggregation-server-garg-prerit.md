...
Currently software carpentry provides the installation-test scripts so that, students can check that they've successfully installed all software required by their workshop. But the results generated by the scripts are not collected anywhere. <br/>
...
* For the better, if time permits, some plots can be generated by extracting useful information about the failures. This can be done using [Plotly](https://plot.ly/), as I have done in my [demo project](https://github.com/prerit2010/SurveyMonkey-Sample). This will provide better understanding by visualization.
