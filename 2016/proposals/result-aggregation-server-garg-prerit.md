...
```
* **Database migration**, i.e. any addition of column, addition of table, updation of table etc, can be done using a database migration tool [Alembic](https://alembic.readthedocs.org/en/latest/), which is specifically built for SQLAlchemy. An Alembic migration script shall be written to do the all the migrations in database. Code Snippet :
```
from alembic import op
from sqlalchemy import Column, TIMESTAMP, func

op.add_column('user_system_info',
...
* For the greater good, some plots can be generated by extracting useful information about the failures. This can be done using [Plotly](https://plot.ly/), as I have done in my [demo project](https://github.com/prerit2010/SurveyMonkey-Sample). This will provide better understanding by visualization.
